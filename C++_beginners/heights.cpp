...
int main()
{
	...
	cout << "The average height of all students is: " << findAverage(heights, 10) << " inches" << endl;
	cout << "The tallest student is: " << findTallest(heights, 10) << " inches" << endl;
...
void getHeights(double h[], int size)
{
	...
	{
		cout << "Enter students height in inches: \n";
		cin >> h[i];
	}
}
